...
<body>
    ...
    <div class="header">
        <div class="meta">
            Emisión: <?php echo e($meta['date']); ?><br>
            Período: <?php echo e(ucfirst($meta['month'])); ?> de <?php echo e($meta['year']); ?>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right"><?php echo e($row->total_quantity); ?></td>
                <td class="text-right">$<?php echo e(number_format($row->total_revenue, 2)); ?></td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <tr class="total-row">
                <td colspan="2">TOTAL GENERAL</td>
                <td class="text-right"><?php echo e($meta['grand_quantity']); ?></td>
                <td class="text-right">$<?php echo e(number_format($meta['grand_revenue'], 2)); ?></td>
            </tr>
        </tbody>
    </table>
...
</html><?php /**PATH C:\laragon\www\CRUD_INTERSYS\resources\views/monthly_pdf.blade.php ENDPATH**/ ?>