...
<div class="container mt-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <a href="{{ route('reports.pdf') }}" class="btn btn-danger">Descargar Reporte del Mes (PDF)</a>
        </div>
    </div>
            ...
            <table class="table table-hover" id="productsTable">
                ...
                <tbody>
                    ...
                    <tr id="row-{{ $product->id }}">
                        ...
                        <td>
                            <button class="btn btn-sm btn-warning btnEditar" data-id="{{ $product->id }}">Editar</button>
                            <button class="btn btn-sm btn-danger btnEliminar" data-id="{{ $product->id }}">Eliminar</button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
